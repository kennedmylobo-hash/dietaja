  ...
  useEffect(() => {
    if (packages.length > 0) {
      ...
      trackMetaEvent({
        ...
        params: { content_type: 'product_group', content_name: 'Marmita Fit 300g', content_category: 'Emagrecimento', value: minPrice, currency: 'BRL', contents: packages.map(p => ({ id: p.id, quantity: p.quantity, item_price: p.pricePerUnit })) },
        tenantId,
      });
    }
  }, [packages.length]);
