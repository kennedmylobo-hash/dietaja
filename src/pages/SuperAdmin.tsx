...
const SuperAdmin = () => {
  ...
  const validateAccess = async (userId: string) => {
    ...
    return {
      hasAdminAccess: adminResult.hasRole || superAdminResult.hasRole,
      hasSuperAdminAccess: superAdminResult.hasRole,
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      if (session) {
        const permission = await validateAccess(session.user.id);
        ...
        } else if (permission.hasAdminAccess) {
