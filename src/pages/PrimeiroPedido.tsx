      ...
      <div className="min-h-screen bg-background">
        ...
        <footer className="px-4 py-6 text-center text-xs text-muted-foreground">
          ...
          <p className="mt-1 flex items-center justify-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3" viewBox="0 1.5 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
